    ...
    <>
      ...
      {!loading && discountedRooms.length > 0 && (
        <div className="fixed bottom-6 right-6 z-40">
          <button
            onClick={reopenModal}
            className="btn btn-circle btn-lg bg-blue-600 hover:bg-blue-700 border-blue-600 hover:border-blue-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 animate-pulse"
      ...
      {isModalOpen && discountedRooms.length > 0 && (
        <div className="modal modal-open z-50">
          <div className="modal-box max-w-6xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 relative">
            {/* Close Button */}
            <button
              onClick={closeModal}
              className="btn btn-sm btn-circle btn-ghost absolute right-4 top-4 text-gray-500 hover:text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-gray-200 dark:hover:bg-gray-700 transition-colors duration-200"
            >
            ...
            <div className="text-center mb-8">
              <div className="flex items-center justify-center gap-3 mb-4">
                <div className="p-3 bg-blue-100 dark:bg-blue-900/30 rounded-full">
                  <FaFire className="text-blue-600 text-2xl" />
                </div>
            ...
            {!loading && discountedRooms.length > 0 && (
              <>
                {/* Promotion Banner */}
                <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-lg p-6 mb-8 text-white text-center shadow-md">
                    ...
                    <div key={room._id} className="relative">
                      ...
                      {room.discountPercentage >= 30 && (
                        <div className="absolute -top-2 -right-2 z-10">
                          <span className="bg-gradient-to-r from-blue-500 to-blue-600 text-white px-3 py-1 rounded-full text-xs font-bold shadow-lg animate-bounce">
                            🔥 HOT DEAL
                          </span>
                        </div>
                      )}
                ...
                {/* CTA Section */}
                <div className="text-center bg-gray-50 dark:bg-gray-700 rounded-lg p-6 border border-gray-200 dark:border-gray-600">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 justify-center">
                    <Link
                      to="/rooms"
                      onClick={closeModal}
                      className="btn bg-blue-600 hover:bg-blue-700 border-blue-600 hover:border-blue-700 text-white px-8 transition-colors duration-200"
                    >
                      Browse All Rooms
                    </Link>
                    <button
                      onClick={closeModal}
                      className="btn btn-outline border-gray-300 text-gray-700 hover:bg-gray-100 hover:border-gray-400 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:border-gray-500 px-8 transition-colors duration-200"
                    >
                      Close
                    </button>
                  </div>
            ...
            {!loading && discountedRooms.length === 0 && (
              <div className="text-center py-12">
                <div className="mb-4">
                  <FaSadTear className="text-6xl text-gray-400 dark:text-gray-500 mx-auto mb-4" />
                </div>
                <h3 className="text-xl font-bold text-gray-800 dark:text-white mb-2">
